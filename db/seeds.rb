...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  events = Event.create([
  { name: 'World of Coca-Cola', description: 'The World of Coca-Cola is a permanent exhibition featuring the history of The Coca-Cola Company—including its well-known advertising—as well as a host of entertainment areas and attractions, and is located in Atlanta, Georgia at Pemberton Place.', address: '121 Baker St NW Atlanta, GA 30313', phone: '(404) 676-5151', 
  ...
  { name: 'Auburn Spring Festival', description:'Spring festival in Historic Sweet Auburn district 5/8/2015 - 5/10/2015.',address:'240 Auburn Avenue Atlanta, GA 30303', phone:'(404) 681-4667', web_address:'', image_address:'', latitude: 33.755694, longitude: -84.379752, category: 1},
  ...
  { name: 'Georgia Aquarium', description: "The world's largest aquarium with 8 million gallons of fresh and marine water, and more than 100,000 animals representing 500 species from around the globe.", address: '225 Baker Street NW Atlanta, GA 30313', phone: '(404) 581-4000', web_address: 'wwww.abc.com', image_address: 'wwww.123.com', latitude: 33.763382, longitude: -84.395110, category: 2 },
  ...
  { name: 'High Velocity', description: "The Marqui Hotel's sports bar restaurant ideal for parties and grabbing a meal with friends.", address: '265 Peachtree Centre Ave Atlanta, GA 30303', phone: '(404) 521-0000', 
  ...
  { name: "Kwan's Deli and Korean Kitchen", description: 'Korean fusioned Asian style menu served in the Centennial Park are for over 10 years.', address: '267 Marietta St NW Atlanta, GA 30313', phone: '(404) 522-9796', web_address: 'http://kwansdeli.com/', image_address: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQFReuVnPQjM6WBao1S3SkQ3_nNwRf08VppyiOAguoSBEHZDon6Yg', latitude: 33.760593, longitude: -84.395035, category: 3 },
  
  { name: 'Joystick Gamebar', description: 'A bar and old-time-retro arcade game room combined to help release some stress and to enjoy the locals. ', address: '427 Edgewood Ave, Atlanta, GA 30312', phone: '(404) 525-3002', web_address: 'http://www.joystickgamebar.com/', image_address: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRa6sI_qQaAVmmREe3rHuI0UXa0p717Y1bswoaknMT8XA-YmSUbZQ', latitude: 33.754528, longitude: -84.372461, category: 3 },
  
  { name: 'Sock Fancy', description: 'Name says it all.', address: '171 Auburn Ave NE Atlanta,GA 30303', phone: '(706)510-7015', 
    web_address: 'http://www.sockfancy.com', image_address: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcR2jIk4eQpwbBKHWdXy5wsu1zsqYWz3CpsoYE17SAi1fUKAgBHmow', latitude: 33.755319, longitude: -84.380592, category: 4 },
  
  { name: "Walter's", description: "Men's sport shoes and clothing store.", address: '66 Decatur St SE Atlanta.GA 30303', phone: '(404) 688-8859', web_address: 'http://waltersclothing.com/', image_address: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSkFejRo1rDCJ0GVIbzkhURQvvYbdb1o83aArYvDVtAeY0ukdIL', latitude: 33.753332, longitude: -84.387663, category: 4 },
  
  { name: 'Eyejets Lifestyle Eyewear', description: 'Fashion spectacles and opticians', address: '250 Spring St Atlanta, GA 30303', phone: '(770)765-3359', web_address: 'https://www.facebook.com/eyejets', image_address: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcToY74rBTnzlFjkAkvARPUEK_BxeOs2JJtC4eKPnhmL5VvGfCi8iA', latitude: 33.761889, longitude: -84.389789, category: 4},
  ...
  { name: 'The Byrd’s Box', description: 'Arty, local, handmade goods', address: '171 Auburn Ave NE, Atlanta, Georgia', phone: '(404) 791-0489', web_address: 'https://www.facebook.com/thebyrdsbox', image_address: 'http://s3-media1.fl.yelpcdn.com/bphoto/w9dedXdD28hawLAKLnS8Eg/l.jpg', latitude: 33.755319, longitude: -84.380592, category: 4},

  { name: 'Just Add Honey', description: 'Local tea shop', address: '171 Auburn Avenue, Atlanta, Georgia 30303', phone: '(404) 725-5286', web_address: 'http://justaddhoney.net/', image_address: 'http://cdn.shopify.com/s/files/1/0066/4662/t/2/assets/logo.png?8621927464716114827', latitude: 33.755319, longitude: -84.380592, category: 4},

  { name: 'AmericasMart Atlanta', description: "AmericasMart Atlanta is the nation's only global wholesale marketplace housing the world's single-largest collection of home, gift, area rug and apparel merchandise." , address: '240 Peachtree St NW, Atlanta, GA 30303', phone: '(404) 220-3000', 
  ...
  { name: 'The Mall at Peachtree Center', description: "Peachtree Center's three-tiered retail mall is located in the heart of Atlanta at the corner of Peachtree Street and International Boulevard." , address: '231 Peachtree St NE, Atlanta, GA 30303', phone: '(404) 654-1296', 
  ...
  { name: 'Polaris', description: "Restaurant sits atop the Hyatt Regency's 25 stories. Menu offers Southern  fare and a sampling of great drinks in a retro atmosphere.", address: '265 Peachtree St NE Atlanta, GA 30303', phone: '(404) 460-6425', 
  ...
  { name: 'Sky Lounge', description: 'Sexy rooftop lounge atop Glenn Hotel, where the out-of-towners and after-work crowd gather into the night.', address: '110 Marietta St NW Atlanta,GA 30303', phone: '(404) 521-2250', 
  ...
  { name: 'Supreme Fish Delight', description: 'Comfort food chain serving fish sandwiches & other casual American fare in a counter-serve space.', address: '362 Auburn Ave NE Atlanta, GA 30312', phone: '(404) 522-5333', web_address: 'http://supremefishdelight.com', image_address: 'https://s3.grouponcdn.com/images/site_images/1542/7427/IMAGE_Supreme-Fish-Delight.jpg', latitude: 33.755712, longitude: -84.375784, category: 3},
  ...
  { name: 'The Sound Table', description: 'Small plates & cocktails served in an industrial space that morphs into a dance club at night.', address: '483 Edgewood Ave SE, Atlanta, GA 30312', phone: '(404) 835-2534', web_address: 'http://www.thesoundtable.com/', image_address: 'http://richmedina.com/wp-content/uploads/2014/10/sound-table-sign-sq-crop.jpg', latitude: 33.755715, longitude: -84.381781, category: 3},

  { name: "Mango's Caribbean Restaurant", description: 'Cool, colorful eatery with paintings of Bob Marley & island life serves curry, jerk, oxtail & more.', address: '180 Auburn Ave NE, Atlanta, GA 30303', phone: '(404) 698-3992', 
  ...
  { name: 'Serpas Restaurant', description: 'Former warehouse with a chic vibe serves Cajun-inspired American cuisine under soaring ceilings.', address: '659 Auburn Ave NE 501, Atlanta, GA 30312', phone: '(404) 688-0040', web_address: 'http://serpasrestaurant.com', image_address: 'http://images.atlanta.net/WebImage.ashx?docid=331274&imagetype=J&sortorder=20762', latitude: 33.756201, longitude: -84.366275, category: 3},

  { name: "Rathbun's", description: 'This lively spot serves creative American plates in a stylish, renovated warehouse.', address: '112 Krog St NE, Atlanta, GA 30307', phone: '(404) 524-8280', web_address: 'http://kevinrathbun.com', image_address: 'http://bearingsguide.com/wp-content/uploads/2010/08/krsimage.jpg', latitude: 33.756172, longitude: -84.364782, category: 3},
  ...
  { name: "Ruth's Chris Steak House", description: 'Caring for our guests by delivering the highest quality food, beverage and service in a warm and inviting atmosphere.', address: '267 Marietta St. Atlanta, GA 30313', phone: '(404) 223-6500', 
  ...
  { name: "McCormick & Schmick's Seafood Restaurant", description: 'Combining an open imagination with a respect for tradition to make McCormick & Schmicks the nations premier family of seafood restauarants.', address: '190 Marietta S NW Atlanta, GA 30303', phone: '(404) 521-1236', 
  ...
  { name: 'Legal Sea Foods', description: "See fish. Eat fish. If it isn't fresh, it isn't Legal.", address: '275 Baker St NW Atlanta, GA 30313', phone: '(678) 500-3700', web_address: 'http://www.legalseafoods.com/restaurants/atlanta-downtown', image_address: 'http://glutenfreedomatlanta.com/wp-content/uploads/2009/09/legal_sf1-300x216.jpg', latitude: 33.761913, longitude: -84.395569, category: 3},

  { name: "Max's Coal Oven Pizzeria", description: "With the only genuine coal-burning oven in Georgia, Max's serves crisp pizza that has been a hallmark of New York City pizzerias for more than a century.", address: '300 Marietta St NW Atlanta, GA 30313', phone: '(404) 974-2491', 
  ...
  { name: 'Atlanta Film Festival 365', description: 'The Atlanta Film Festival is one of the largest and longest-running festival in the country, welcoming an audience of over 25,000 to discover hundreds of new independent, international, animated, documentary, and short films, selected from 3000+ submissions from all over the world.', address: '1 Park Pl NE Atlanta, GA 30303', phone: '(404) 352-4225', 
    web_address: 'http://atlantafilmfestival.com', image_address: 'http://t0.gstatic.com/images?q=tbn:ANd9GcTlBL-Sfrk6SkhrwT4zAl_c_yjmpfsbZh51-j1Vu_rcPSsMxKCj3Q', latitude: 33.754366, longitude: -84.388789, category: 2},
  ...
  { name: 'SkyView Atlanta', description: 'Towering nearly 20 stories above Centennial Park, the SkyView Ferris wheel features 42 climate-controlled gondolas providing guest with breathtaking panoramic views of downtown Atlanta and the surrounding metropolitan area.', address: '168 Luckie St NW Atlanta, GA 30303', phone: '(678) 949-9023', 
    web_address: 'http://skyviewatlanta.com', image_address: 'http://media-cdn.tripadvisor.com/media/photo-s/05/9d/ff/79/skyview-atlanta.jpg', latitude: 33.758847, longitude: -84.391811, category: 2},
  ...
  { name: 'Georgia State Capitol', description: "A National Historic Landmark listed on the National Register of Historic Places, the Georgia State Capitol is the main office building of Georgia's government.", address: '206 Washington St SW Atlanta, GA 30334', phone: '(404) 656-2846', web_address: 'http://www.atlantaga.gov/index.aspx/index.aspx?page=472', image_address: 'http://2.bp.blogspot.com/-gx1HVQm6-RU/ToMHKtH8CqI/AAAAAAAAAoA/NtICHlOBgMQ/s1600/ga+state+cap.jpg', latitude: 33.748994, longitude: -84.38805, category: 2},
  ...
  { name: 'College Football Hall of Fame', description: 'Newly opened in 2014 housing a single place for all college sports fans to come gather and see their team favorites downtown at the Luckie District.', address: '250 Marietta Street NW Atlanta, GA 30313', phone: '(404) 527-6949', 
  ...
  { name: 'Historic Oakland Cemetery', description: 'No matter where you turn, history surrounds you at Oakland Cemetery. It is a shining example of the “rural garden” cemetery movement of the 19th century.', address: '248 Oakland Ave, SE Atlanta, GA 30312', phone: '4041234567', web_address: 'http://www.oaklandcemetery.com/', image_address: 'http://www.maliasmiles.com/blog/wp-content/uploads/2014/10/Oakland-entrance.jpg', latitude: 33.747842, longitude: -84.375125, category: 2 },  

  { name: 'CNN Center', description: "The CNN Center is the world headquarters of the Cable News Network, with the main newsrooms and studios for several of CNN's news channels located in the building.", address: '190 Marietta St NW Atlanta, GA 30303', phone: '(404) 827-2300', web_address: 'http://www.cnncenterretail.com/', image_address: 'http://images.nationalgeographic.com/wpf/media-live/photos/000/016/cache/atlanta-cnn-center_1617_600x450.jpg', latitude: 33.757644, longitude: -84.394645, category: 2 },

  { name: 'National Center for Civil and Human Rights', description: 'The Center for Civil and Human Rights is a museum dedicated to the achievements of both the civil rights movement in the United States and the broader worldwide human rights movement.', address: '55 Ivan Allen Jr. Blvd. Ste. 510 Atlanta, GA 30308', phone: '(404) 991-6970', 
  ...
  { name: 'APEX Museum', description: 'APEX is an acronym for African-American Panoramic Experience. This title embodies the mission of the APEX. It also provides its visitors with a complete view of African-American history.', address: '135 Auburn Ave Atlanta, Georgia 30303', phone: '(404) 523-2739', web_address: 'http://www.apexmuseum.org', image_address: 'http://clatl.com/imager/b/magnum/10807659/57e5/APEX_Museum_Magnum.jpg', latitude: 33.75527, longitude: -84.383087, category: 1 },

  { name: "Balzer Theater at Herren’s", description: 'Theatrical outfit that entertains, educates and enlivens with stories that stir the soul. Classic and contemporary theater in the heart of downtown Atlanta.', address: '84 Luckie St, Atlanta, GA 30303', phone: '(678) 528-1500', web_address: 'http://www.theatricaloutfit.org/', image_address: 'http://www.atlantadowntown.com/_files/images/theatrical-outfit.jpg', latitude: 33.757018, longitude: -84.389603, category: 1 },

  { name: 'The Tabernacle', description: 'Visit the Tabernacle for live entertainment and private events located at 152 Luckie Street, Atlanta.', address: '152 Luckie St NW Atlanta, GA 30303', phone: '(404) 659-9022', web_address: 'http://www.tabernacleatl.com', image_address: 'https://res.cloudinary.com/roadtrippers/image/upload/c_fill,h_316,w_520/v1381848509/the-tabernacle-51c89d257f3d77125f002119.jpg', latitude: 33.758937, longitude: -84.39144, category: 1 },

  { name: "Imagine IT! Children’s Museum of Atlanta", description: "The children's museum located in Downtown, adjacent to Centennial Olympic Park.", address: '275 Centennial Olympic Park Dr Atlanta, GA 30303', phone: '(404) 659-5437', web_address: 'http://www.childrensmuseumatlanta.org/', image_address: 'http://www.ourlifememories.com/wp-content/uploads/2011/03/IMG_06232.jpg', latitude: 33.762467, longitude: -84.391694, category: 1 },
  ...
  { name: 'The Music Room', description: 'Music venue under Pizzeria Vesuvius. The Music Room caters to live music and DJ near the Old Fourth Ward area.', address: '327 Edgewood Ave, Atlanta, GA 30312', phone: '(404) 341-0111', web_address: 'https://www.facebook.com/TheMusicRoomATL?rf=151557841531776', image_address: 'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSOkozkDzZ5rbRjqgWtl5rzQspkg_Rs9QSM2VptpqhUTYHGtGKU', latitude: 33.754153, longitude: -84.376903, category: 1 },

  { name: 'Eyedrum', description: 'Eyedrum Art & Music Gallery is a non-profit art space and venue in Atlanta, Georgia focused on contemporary art and experimental music ranging from contemporary chamber music and sound sculpture to drone noise music and art rock.', address: '88 Forsyth Street Dr Atlanta, GA 30303', phone: '(404) 522-0655', web_address: 'http://www.eyedrum.org/', image_address: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpl-gFuUSmWy2rhn0xaY06QJhSqi9hGrn7Y8msrGJeg4AQtVdHBQ', latitude: 33.751881, longitude: --84.391455, category: 1 },
  ])
